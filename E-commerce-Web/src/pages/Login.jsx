...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* Content */}
      <div className="flex-1 flex flex-col px-6 sm:px-8 pb-8 sm:items-center sm:justify-center">
        {/* Logo & Title */}
        ...
        <div className="relative my-6 w-full max-w-sm">
          ...
          <div className="relative flex justify-center">
            <span className="px-3 bg-gray-50 text-gray-400 text-xs">or continue with</span>
          </div>
        </div>
        ...
        {/* Sign Up Link */}
        <p className="text-center text-gray-500 text-sm mt-6 w-full max-w-sm">
